...
| [`kinetis/mcp-docs`](https://github.com/kinetis-dev/mcp-docs) | A standalone MCP server serving the Kinetis documentation — framework-agnostic | [![Version](https://img.shields.io/packagist/v/kinetis/mcp-docs?label=)](https://packagist.org/packages/kinetis/mcp-docs) |
| [`kinetis/orbitron`](https://github.com/kinetis-dev/orbitron) | A development-only construction harness — portable Kinetis context, the installed-package inventory, layout verification and one previewable scaffold, from a shell or over MCP | [![Version](https://img.shields.io/packagist/v/kinetis/orbitron?label=)](https://packagist.org/packages/kinetis/orbitron) |
