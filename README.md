...
| [`kinetis/orbitron`](https://github.com/kinetis-dev/orbitron) | A development-only construction harness — portable Kinetis context, the installed-package inventory, layout verification and one previewable scaffold, from a shell or over MCP, where it also serves the documentation resources | [![Version](https://img.shields.io/packagist/v/kinetis/orbitron?label=)](https://packagist.org/packages/kinetis/orbitron) |
