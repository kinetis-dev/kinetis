...
| [`kinetis/orm`](packages/orm) | A read-side data mapper — attributed entities, typed repositories, an identity map per unit of work | [![Version](https://img.shields.io/packagist/v/kinetis/orm?label=)](https://packagist.org/packages/kinetis/orm) |
