...
| [`kinetis/mcp-docs`](https://github.com/kinetis-dev/mcp-docs) | The Kinetis documentation catalogue and fetch as MCP resources — framework-agnostic, installable on its own or composed by kinetis/orbitron | [![Version](https://img.shields.io/packagist/v/kinetis/mcp-docs?label=)](https://packagist.org/packages/kinetis/mcp-docs) |
| [`kinetis/orbitron`](https://github.com/kinetis-dev/orbitron) | A development-only construction harness — portable Kinetis context, the installed-package inventory, layout verification and one previewable scaffold, from a shell or over MCP, where it also serves the documentation resources and the exact installed `kinetis/*` package source | [![Version](https://img.shields.io/packagist/v/kinetis/orbitron?label=)](https://packagist.org/packages/kinetis/orbitron) |
