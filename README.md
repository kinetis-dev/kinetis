...
| [`kinetis/mcp-protocol`](https://github.com/kinetis-dev/mcp-protocol) | MCP 2025-06-18 over JSON-RPC as a framework-agnostic library — envelopes, typed tool and resource contracts, stdio framing | [![Version](https://img.shields.io/packagist/v/kinetis/mcp-protocol?label=)](https://packagist.org/packages/kinetis/mcp-protocol) |
...
| [`kinetis/mcp-docs`](https://github.com/kinetis-dev/mcp-docs) | The Kinetis documentation catalogue and fetch as MCP resources, plus a tool that reads a bounded line window of a page and one that searches a page for a literal string — framework-agnostic, installable on its own or composed by kinetis/orbitron | [![Version](https://img.shields.io/packagist/v/kinetis/mcp-docs?label=)](https://packagist.org/packages/kinetis/mcp-docs) |
| [`kinetis/orbitron`](https://github.com/kinetis-dev/orbitron) | A development-only construction harness — portable Kinetis context, the installed-package inventory, layout verification and one previewable scaffold, from a shell or over MCP, where it also serves the documentation pages — whole or in bounded windows — and the exact source of any package the project has installed | [![Version](https://img.shields.io/packagist/v/kinetis/orbitron?label=)](https://packagist.org/packages/kinetis/orbitron) |
