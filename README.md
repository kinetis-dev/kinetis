...
| [`kinetis/orm`](packages/orm) | A data mapper — attributed entities, typed repositories, and a unit of work with change tracking and a transactional flush | [![Version](https://img.shields.io/packagist/v/kinetis/orm?label=)](https://packagist.org/packages/kinetis/orm) |
| [`kinetis/views`](packages/views) | Engine-neutral view rendering and asset URLs | [![Version](https://img.shields.io/packagist/v/kinetis/views?label=)](https://packagist.org/packages/kinetis/views) |
| [`kinetis/views-php`](packages/views-php) | Pure PHP templates for kinetis/views | [![Version](https://img.shields.io/packagist/v/kinetis/views-php?label=)](https://packagist.org/packages/kinetis/views-php) |
| [`kinetis/views-latte`](packages/views-latte) | Latte templates for kinetis/views | [![Version](https://img.shields.io/packagist/v/kinetis/views-latte?label=)](https://packagist.org/packages/kinetis/views-latte) |
| [`kinetis/views-twig`](packages/views-twig) | Twig templates for kinetis/views | [![Version](https://img.shields.io/packagist/v/kinetis/views-twig?label=)](https://packagist.org/packages/kinetis/views-twig) |
...
| [`kinetis/queue`](packages/queue) | A backend-agnostic background job queue — every backend lives in its own separate package | [![Version](https://img.shields.io/packagist/v/kinetis/queue?label=)](https://packagist.org/packages/kinetis/queue) |
| [`kinetis/queue-redis`](packages/queue-redis) | Redis backend for kinetis/queue | [![Version](https://img.shields.io/packagist/v/kinetis/queue-redis?label=)](https://packagist.org/packages/kinetis/queue-redis) |
| [`kinetis/queue-sql`](packages/queue-sql) | MySQL/Postgres backend for kinetis/queue | [![Version](https://img.shields.io/packagist/v/kinetis/queue-sql?label=)](https://packagist.org/packages/kinetis/queue-sql) |
...
| [`kinetis/authorization`](packages/authorization) | Unopinionated ability-based authorization — Gate wraps any callable Policy check | [![Version](https://img.shields.io/packagist/v/kinetis/authorization?label=)](https://packagist.org/packages/kinetis/authorization) |
| [`kinetis/storage`](packages/storage) | File storage on League\Flysystem, Amp\File-backed local driver | [![Version](https://img.shields.io/packagist/v/kinetis/storage?label=)](https://packagist.org/packages/kinetis/storage) |
...
| [`kinetis/aws-sigv4`](packages/aws-sigv4) | PSR-18 client signing requests with AWS Signature V4 | [![Version](https://img.shields.io/packagist/v/kinetis/aws-sigv4?label=)](https://packagist.org/packages/kinetis/aws-sigv4) |
...
| [`kinetis/search`](packages/search) | The shared search transport and one engine-neutral client for both engines | [![Version](https://img.shields.io/packagist/v/kinetis/search?label=)](https://packagist.org/packages/kinetis/search) |
...
| [`kinetis/search-elasticsearch`](packages/search-elasticsearch) | Non-blocking Elasticsearch client construction | [![Version](https://img.shields.io/packagist/v/kinetis/search-elasticsearch?label=)](https://packagist.org/packages/kinetis/search-elasticsearch) |
| [`kinetis/broadcasting`](packages/broadcasting) | Real-time broadcasting over the Pusher Channels protocol, with private/presence channel authorization | [![Version](https://img.shields.io/packagist/v/kinetis/broadcasting?label=)](https://packagist.org/packages/kinetis/broadcasting) |
...
| [`kinetis/mcp-docs`](packages/mcp-docs) | A standalone MCP server serving the Kinetis documentation — no Kinetis dependency | [![Version](https://img.shields.io/packagist/v/kinetis/mcp-docs?label=)](https://packagist.org/packages/kinetis/mcp-docs) |
