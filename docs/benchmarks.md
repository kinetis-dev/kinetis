...
|---|---|---|---|
| `kinetis` | kinetis/framework | 1.17.1 | 8.5.9 (FrankenPHP, ZTS) |
| `kinetis-fpm` | kinetis/framework | 1.17.1 | 8.4.24 |
...
`kinetis`/`kinetis-fpm` also ran kinetis/persistence 1.10.1 and
kinetis/query-builder 1.2.4. FrankenPHP-based targets run a newer PHP
