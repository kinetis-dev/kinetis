...
fully-configured PSR-18 client — Content-Type, Basic auth, and TLS
options already applied — right before it reaches OpenSearch's own
`TransportFactory`:
...
see that page for a span per OpenSearch call.
