 ...
 * ExceptionHandlerMiddleware Kernel includes unconditionally — inside
 * SecurityHeadersMiddleware and any registered CorsMiddleware — reads
 * the status off this interface, so installing this package wires
 * nothing and there is no middleware for an application to register,
 * order, or accidentally leave out.
 *
