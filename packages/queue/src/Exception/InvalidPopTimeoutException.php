 ...
 * either side of that split, and every backend previously treated it the
 * same as 0 (unbounded blocking) — silently ignoring what was very
 * likely a caller's own mistake (a miscomputed remaining-timeout value,
 * for one) rather than surfacing it.
 */
