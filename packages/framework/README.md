...
| [`kinetis/mcp-docs`](https://github.com/kinetis-dev/mcp-docs) | The Kinetis documentation as MCP resources, served on its own or composed by [`kinetis/orbitron`](https://github.com/kinetis-dev/orbitron) — framework-agnostic, with [`kinetis/mcp-protocol`](https://github.com/kinetis-dev/mcp-protocol) its only Kinetis dependency |
