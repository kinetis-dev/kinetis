...
final class FrankenPhpAdapterTest extends TestCase
{
    ...
    {
        self::assertTrue((new FrankenPhpAdapter(TrustedProxies::fromList([])))->isPersistent());
    }
    ...
    public function test_run_throws_when_the_frankenphp_extension_is_unavailable(): void
    {
        ...
        (new FrankenPhpAdapter(TrustedProxies::fromList([])))->run(static fn () => throw new \LogicException('should never run'));
    }
}
