...
final class MissingClassReaderSection implements CacheableDiscoveryInterface
{
    #[\Override]
    public static function compile(DiscoveryContext $context): array
    {
        return ['upstream' => $context->compiled('Kinetis\Tests\Cache\Fixtures\Sections\DoesNotExistSection')];
    }
