...
use Kinetis\Tests\Mcp\Fixtures\DisposeRecorder;
use Kinetis\Tests\Mcp\Fixtures\ScopeProbeToolController;
...
final class McpScopeLifecycleTest extends TestCase
{
    ...
    {
        $app = $this->app();
        $kernel = new Kernel($app, new Router(), mcp: new McpServer($this->registry(), new McpDispatcher($app)));
